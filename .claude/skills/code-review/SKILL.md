...
2. **Analyze** — Evaluate against `references/python-standards.md`. Categorize each finding by pillar and severity.
...
- **Path:** `/media/ak/d1c5342e-77c5-411d-a9ac-03660a90ce7d/home/ak/Gitrepos/2026_research_tracks/reviews`
